# This code was copied from https://github.com/banjo/fb-birthdays
...
with open("src/facebook_scrape_birthdays/example_help_data.json", "r") as f:
    url_data = json.load(f)

url = url_data['facebook_bday_links']['owen2']
